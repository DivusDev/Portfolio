            ...
            <Grid container className='home background' >
                <Grid item className='scrollpage '  xs={12}>
                    ...
                    <div class="custom-shape-divider-top-1644127656" >
                        <div class='custom-shape-divider-top-part-1644127656'></div>
                        ...
                        <span className='title-subheading'>I'm a Software Engineer, specializing in building and maintaining large scale React and SQL Solutions.</span>
                ...
                <Grid item className='scrollpage '  xs={12}>
                    <div className='aboutme-container'>
                        <span className='aboutme-name'>Tristan Schwichow</span>
                        <span className='aboutme-subheading'>Passionate. Experienced. Intrigued. </span>
                        <div className="aboutme-triangle"></div>
                    </div>
                    <div className='portfolio-photo'>
